...
Result page
  ...
  • wheel chart inline (visible flow; not collapsed expander)
  • report §§1–5 markdown
...
| Chart | wheel-only SVG inline (not in collapsed expander — Cloud height measure); `st.iframe(..., height="content")` + CJK font injection |
