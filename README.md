...
3. 按太阳座 × MBTI 查出「隐藏人格」人设卡（192 选 1；**白羊→射手共 9 星座各有 16 张 MBTI 专属图（已接入 144 张）**，其余星座暂不展示人格成品图）
...
personapicture/mbti_tarot_cards/cancer/v1/  # 巨蟹 × 16
...
personapicture/mbti_tarot_cards/sagittarius/v1/ # 射手 × 16
...
| 人设卡 | 太阳×MBTI → 192 文案；**白羊→射手共 9 星座各 16 张专属图**（manifest+WebP，已接入 144 张），其它星座暂不展示人格成品图 |
...
| 主按钮 | `解读 {古希腊星座}`（如 `解读 καρκίνος`）或「生成解读」；隐私在提交旁 |
